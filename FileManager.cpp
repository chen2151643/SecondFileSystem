...
/* 返回NULL表示目录搜索失败，否则是个指针，指向文件的内存打开i节点 ，上锁的内存i节点  */
...
void FileManager::Creat()
{
	...
	if (NULL == pInode)
	{
		 ...
		 * 所表示的权限内容是一样的。
		 */
		/* CC:这里不知道为什么要用FWRITE，而不是读写都有，我改成刚创的文件读写都可了 */
...
* 打开文件，创建内存File结构，勾连起FIle-Inode-fd
*/
